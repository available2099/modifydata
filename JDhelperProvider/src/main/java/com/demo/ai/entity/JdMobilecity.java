...
/**
 * jd_plantBean(JdMobilecity)实体类
 *
 * @author makejava
 * @since 2020-10-21 15:30:27
 */
public class JdMobilecity implements Serializable {
    private static final long serialVersionUID = -16471437050790856L;
