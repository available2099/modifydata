...
await $.http.get({url: "http://jdhelper.tk/fruit/"+$.farmInfo.farmUserPro.shareCode+"?ti="+new Date()}).then((resp) => {jdFruitShareArr=[];jdFruitShareArr.push(resp.body);console.log(`
【查询jdFruitShareArr】
