...
await $.http.get({url: "http://jdhelper.tk/plantbean/"+$.myPlantUuid+"?ti="+new Date()}).then((resp) => {jdPlantBeanShareArr=resp.body.split(`@`);console.log(`【查询jdBeanShareArr】`+resp.body);});await shareCodesFormat();
